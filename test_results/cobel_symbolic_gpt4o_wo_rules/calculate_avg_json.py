...
def main():
    # 读取所有 JSON 文件
    json_data_list = load_json_files('test_results/cobel_symbolic_gpt4o_wo_rules/')
    ...
    # 保存到新文件
    output_filename = 'test_results/cobel_symbolic_gpt4o_wo_rules/averaged_results.json'
